...
public class ConectaBanco {
    ...
    private final String path = "jdbc:sqlserver://localhost:1433;databaseName=Cafe;trustServerCertificate=true";
    private final String user = "rt";
    private final String pass = "121200";
